...
RCT_EXPORT_METHOD(prehashPassword
                  : (nonnull NSString*)password resolve
...
RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(create, id, create
                                      : (nonnull NSDictionary<NSString*, id>*)optionsDict version
...
RCT_REMAP_METHOD(start, start
                 : (double)handle identity
                 : (nonnull NSString*)identity resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  [tanker startWithIdentity:identity
          completionHandler:^(TKRStatus status, NSError* _Nullable err) {
            if (err != nil)
              return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(registerIdentity, registerIdentity
                 : (double)handle verification
                 : (nonnull NSDictionary<NSString*, id>*)verificationDict options
                 : (nullable NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  [tanker registerIdentityWithVerification:tankerVerification
                                   options:tankerOptions
                         completionHandler:^(NSString* _Nullable sessionToken, NSError* _Nullable err) {
                           if (err != nil)
                             return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(verifyIdentity, verifyIdentity
                 : (double)handle verification
                 : (nonnull NSDictionary<NSString*, id>*)verificationDict options
                 : (nullable NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (!tankerVerification)
    return rejectInvalidVerificationDict(reject);
  [tanker verifyIdentityWithVerification:tankerVerification
                                 options:tankerOptions
                       completionHandler:^(NSString* _Nullable sessionToken, NSError* _Nullable err) {
                         if (err != nil)
                           return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(setVerificationMethod, setVerificationMethod
                 : (double)handle verification
                 : (nonnull NSDictionary<NSString*, id>*)verificationDict options
                 : (nullable NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (!tankerVerification)
    return rejectInvalidVerificationDict(reject);
  [tanker setVerificationMethodWithVerification:tankerVerification
                                        options:tankerOptions
                              completionHandler:^(NSString* _Nullable sessionToken, NSError* _Nullable err) {
                                if (err != nil)
                                  return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(generateVerificationKey, generateVerificationKey
                 : (double)handle resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
...
RCT_REMAP_METHOD(getVerificationMethods, getVerificationMethods
                 : (double)handle resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (!tanker)
    return rejectInvalidHandle(reject, handle);
  [tanker verificationMethodsWithCompletionHandler:^(NSArray<TKRVerificationMethod*>* _Nullable methods,
                                                     NSError* _Nullable err) {
    if (err != nil)
      return rejectWithError(reject, err);
    NSArray<NSDictionary<NSString*, id>*>* jsonMethods = [Utils verificationMethodsToJsonWithMethods:methods
                                                                                               error:&err];
    if (err != nil)
      return rejectWithError(reject, err);
    resolve(jsonMethods);
...
RCT_REMAP_METHOD(createOidcNonce, createOidcNonce
                 : (double)handle resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
...
RCT_REMAP_METHOD(setOidcTestNonce, setOidcTestNonce
                 : (double)handle nonce
                 : (nonnull NSString*)nonce resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
...
RCT_REMAP_METHOD(authenticateWithIDP, authenticateWithIDP
                 : (double)handle providerID
                 : (nonnull NSString*)providerID subjectCookie
                 : (nonnull NSString*)subjectCookie resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  [tanker authenticateWithIDP:providerID
                       cookie:subjectCookie
            completionHandler:^(TKRVerification* _Nullable verif, NSError* _Nullable err) {
              if (err != nil)
                return rejectWithError(reject, err);
              NSDictionary<NSString*, id>* verifDict = [Utils oidcAuthCodeDictFromVerif:verif];
              if (verifDict == nil)
                return rejectWithInternalError(reject,
                                               @"authenticateWithIDP received invalid "
                                               @"verification result, this should never happen");
              resolve(verifDict);
            }];
}

RCT_REMAP_METHOD(attachProvisionalIdentity, attachProvisionalIdentity
                 : (double)handle identity
                 : (nonnull NSString*)identity resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (!tanker)
    return rejectInvalidHandle(reject, handle);
  [tanker attachProvisionalIdentity:identity
                  completionHandler:^(TKRAttachResult* _Nullable result, NSError* _Nullable err) {
                    if (err != nil)
                      return rejectWithError(reject, err);
                    ...
                    if (result.method)
                    {
                      NSDictionary<NSString*, id>* jsonMethod = [Utils verificationMethodToJsonWithMethod:result.method
                                                                                                    error:&err];
                      if (err != nil)
                        return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(verifyProvisionalIdentity, verifyProvisionalIdentity
                 : (double)handle verification
                 : (nonnull NSDictionary<NSString*, id>*)verificationDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  @try
  {
    ...
    if (!verificationDict)
      return rejectInvalidVerificationDict(reject);
    [tanker verifyProvisionalIdentityWithVerification:verification
                                    completionHandler:^(NSError* _Nullable err) {
                                      if (err != nil)
                                        return rejectWithError(reject, err);
                                      resolve(nil);
...
RCT_REMAP_METHOD(encryptString, encryptString
                 : (double)handle clearText
                 : (nonnull NSString*)clearText options
                 : (nullable NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
...
RCT_REMAP_METHOD(decryptString, decryptString
                 : (double)handle encryptedText
                 : (nonnull NSString*)b64EncryptedText resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  [tanker decryptStringFromData:encryptedData
              completionHandler:^(NSString* _Nullable decryptedString, NSError* _Nullable err) {
                if (err != nil)
                  return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(encryptData, encryptData
                 : (double)handle clearData
                 : (nonnull NSString*)b64ClearData options
                 : (nullable NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
...
RCT_REMAP_METHOD(decryptData, decryptData
                 : (double)handle encryptedData
                 : (nonnull NSString*)b64EncryptedData resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  if (!encryptedData)
    return reject(errorCodeToString(TKRErrorInvalidArgument), @"Invalid base64 encrypted data", nil);
  [tanker decryptData:encryptedData
      completionHandler:^(NSData* _Nullable decryptedData, NSError* _Nullable err) {
        if (err != nil)
          return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(share, share
                 : (double)handle resourceIds
                 : (nonnull NSArray<NSString*>*)resourceIds options
                 : (nonnull NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  ...
  [tanker shareResourceIDs:resourceIds
                   options:options
         completionHandler:^(NSError* _Nullable err) {
           if (err != nil)
             return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(getResourceId, getResourceId
                 : (double)handle encryptedData
                 : (nonnull NSString*)b64EncryptedData resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
...
RCT_REMAP_METHOD(createGroup, createGroup
                 : (double)handle publicIdentities
                 : (nonnull NSArray<NSString*>*)identities resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKRTanker* tanker = [self.tankerInstanceMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  if (!tanker)
    return rejectInvalidHandle(reject, handle);
  [tanker createGroupWithIdentities:identities
                  completionHandler:^(NSString* _Nullable groupID, NSError* _Nullable err) {
                    if (err != nil)
                      return rejectWithError(reject, err);
                    resolve(groupID);
                  }];
...
RCT_REMAP_METHOD(updateGroupMembers, updateGroupMembers
                 : (double)handle groupId
                 : (nonnull NSString*)groupId options
                 : (nonnull NSDictionary<NSString*, id>*)optionsDict resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (!usersToRemove)
    usersToRemove = @[];
  [tanker updateMembersOfGroup:groupId
...
RCT_REMAP_METHOD(createEncryptionSession, createEncryptionSession
                 ...
                 : (RCTPromiseRejectBlock)reject)
{
  ...
  if (err != nil)
    return rejectWithError(reject, err);
  [tanker
      createEncryptionSessionWithCompletionHandler:^(TKREncryptionSession* _Nullable session, NSError* _Nullable err) {
        if (err != nil)
          return rejectWithError(reject, err);
...
RCT_REMAP_METHOD(encryptionSessionEncryptString, encryptionSessionEncryptString
                 : (double)handle clearText
                 : (nonnull NSString*)text resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
...
RCT_REMAP_METHOD(encryptionSessionEncryptData, encryptionSessionEncryptData
                 : (double)handle clearData
                 : (nonnull NSString*)b64ClearData resolve
                 : (RCTPromiseResolveBlock)resolve reject
                 : (RCTPromiseRejectBlock)reject)
{
  TKREncryptionSession* session = [self.encryptionSessionMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
...
RCT_REMAP_BLOCKING_SYNCHRONOUS_METHOD(encryptionSessionGetResourceId, id, encryptionSessionGetResourceId
                                      : (double)handle)
{
  TKREncryptionSession* session = [self.encryptionSessionMap objectForKey:[NSNumber numberWithUnsignedInt:handle]];
  if (!session)
